...
function createInstantAnimation({ keyframes: keyframes3, delay: delayBy, onUpdate, onComplete }) {
  const setValue = () => {
  ...
  const getLabelProps = (0, import_react82.useCallback)(
    (props2 = {}, forwardedRef = null) => {
      ...
      return {
        ...
        id: (_a2 = props2.id) != null ? _a2 : labelId,
        htmlFor: (_b = props2.htmlFor) != null ? _b : id4
      };
    },
...
function useSpinner(increment, decrement) {
  ...
  const stop2 = (0, import_react146.useCallback)(() => {
    setRunOnce(true);
    setIsSpinning(false);
    removeTimeout();
  }, []);
