...
var transformFunctions = {
  ...
  flexDirection(value) {
    var _a7;
    const { space: space2, divide: divide2 } = (_a7 = flexDirectionTemplate[value]) != null ? _a7 : {};
...
function tokenToCssVar(token2, prefix4) {
  return cssVar2(String(token2).replace(/\./g, "-"), void 0, prefix4);
}
  ...
  for (const [token2, tokenValue] of Object.entries(flatTokens)) {
    ...
    if (!isSemantic) {
      if (token2.startsWith("space")) {
        ...
        const negativeValue = calc2.negate(value);
        const negatedReference = calc2.negate(reference);
...
var $bg4 = cssVar("tooltip-bg");
var $fg3 = cssVar("tooltip-fg");
...
var $bg10 = cssVar("number-input-bg");
var $fg4 = cssVar("number-input-color");
var $border2 = cssVar("number-input-border-color");
...
var $size3 = cssVar("close-button-size");
var $bg13 = cssVar("close-button-bg");
...
//# sourceMappingURL=chunk-R2MJJVN2.js.map
